...
export default function PurchaseOrdersTable({ purchaseOrders, selectedIds, onSelect, onSelectAll, onRowClick }) {
  const allSelected = purchaseOrders.length > 0 && selectedIds.length === purchaseOrders.length
  const someSelected = selectedIds.length > 0 && selectedIds.length < purchaseOrders.length

          ...
          <AuthBox title="Create an account">
            <form className="space-y-2" onSubmit={handleSubmit}>
              ...
              <label className="flex items-center text-sm text-gray-600 mt-2">
                ...
                <span>
                  I agree to the{' '}
                  <Link to="/terms" className="text-purple-600 hover:text-purple-700 underline" target="_blank">
                    Terms of Service
                  </Link>
                  {' '}and{' '}
                  <Link to="/privacy" className="text-purple-600 hover:text-purple-700 underline" target="_blank">
                    Privacy Policy
                  </Link>
                  .
                </span>

...
export default function CustomerInvoiceDrawer({ order, onClose, onUpdate }) {
  ...
  const handlePost = async () => {
    try {
      await customerInvoicesApi.post(order.id)
      onUpdate()
    } catch (error) {
  ...
  const handleCancel = async () => {
    try {
      await customerInvoicesApi.cancel(order.id)
      onUpdate()
    } catch (error) {
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-lg p-4 space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm font-medium text-gray-900">{formatDate(order.invoiceDate)}</span>
                  </div>
                  <div className="flex justify-between">

...
export default function SalesOrdersTable({ salesOrders, selectedIds, onSelect, onSelectAll, onRowClick }) {
  const allSelected = salesOrders.length > 0 && selectedIds.length === salesOrders.length
  const someSelected = selectedIds.length > 0 && selectedIds.length < salesOrders.length

/**
 * ============================================================================
 * Create Sample Employee User Script
 * ============================================================================
 * This script creates a sample employee user for testing
 * 
 * Credentials:
...
async function createSampleEmployee() {
    try {
        ...
        if (existingUser.rows.length > 0) {
            console.log('⚠️  User employee@ggw.com already exists!');
            ...
            // Remove existing roles and assign team_member role
            await query(
            ...
            console.log('╠════════════════════════════════════════════════╣');
            console.log('║ Email:    employee@ggw.com                     ║');
